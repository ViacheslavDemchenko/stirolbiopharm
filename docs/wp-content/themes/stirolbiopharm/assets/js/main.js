...
function catalog() {
  if (document.querySelector('.medicine__menu-title')) {
    var catalogBtn = document.querySelector('.medicine__menu-title');
    var catalogList = document.querySelector('.medicine__menu-list');
    var catalogAlphabet = document.querySelector('.medicine__products-alphabet');
    var screenWidth = window.innerWidth;
    var catalogMenuOpen = function catalogMenuOpen() {
    ...
    catalogMenuOpen();
    var catalogMenuLinks = function catalogMenuLinks() {
    ...
    catalogMenuLinks();
    var catalogMenuClose = function catalogMenuClose() {
      console.log('yes');
...
function pills() {
  if (document.querySelector('.products__items')) {
    var items = document.querySelectorAll('.products__item-icon');
    function showPills() {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return stickyMenu; });
function stickyMenu() {
  ...
  var screnW = screen.availWidth;
  var headerScrollFromTop;
  if (screnW > 1320) {
  ...
  document.body.addEventListener('scroll', function () {
    ...
    if (distanceScrolled > headerScrollFromTop) {
      ...
      headerBg.style.paddingTop = "".concat(menuHeight, "px");
    } else {
