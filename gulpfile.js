...
const buildFolder1 = './build';
const buildFolder2 = './docs';
...
*/
const projectName = 'stirolbiopharm';

const themePath1 = `${buildFolder1}/wp-content/themes/${projectName}/assets/`; // For wordpress
const themePath2 = `${buildFolder2}/wp-content/themes/${projectName}/assets/`;
...
const paths = {
    ...
    scss: {
        ...
        dest1: `${themePath1}/css`,
        dest2: `${themePath2}/css`,
    ...
    images: {
        ...
        dest1: `${themePath1}/img`,
        dest2: `${themePath2}/img`,
    ...
    svgSprite: {
        ...
        dest1: `${themePath1}/img/icons`,
        dest2: `${themePath2}/img/icons`,
    ...
    fonts: {
        src: './src/fonts/**/*',
        dest1: `${themePath1}/fonts`,
        dest2: `${themePath2}/fonts`,
        watch: './src/fonts/**/*'
    },
    php: {
        src: './src/php/**/*.php',
        dest1: `${themePath1}/php`,
        dest2: `${themePath2}/php`,
        watch: './src/php/**/*.php'
    },
    video: {
        src: './src/video/**/*.*',
        dest1: `${themePath1}/video`,
        dest2: `${themePath2}/video`,
        watch: './src/video/**/*.*'
    }
};
...
gulp.task('pug', () => {
  return gulp.src(paths.pug.src)
    ...
    .pipe(gulp.dest(paths.pug.dest1))
    .pipe(gulp.dest(paths.pug.dest2))
...
gulp.task('styles', () => {
  return gulp.src(paths.scss.src)
    ...
    .pipe(gcmq())
    .pipe(gulp.dest(paths.scss.dest1))
    .pipe(gulp.dest(paths.scss.dest2))
    .pipe(cleanCSS())
...
gulp.task('imgmin', () => {
  return gulp.src(paths.images.src)
    .pipe(plumber())
    .pipe(newer(paths.images.dest1))
    .pipe(newer(paths.images.dest2))
    .pipe(imagemin([
        imgCompress({
            loops: 4,
            min: 70,
    ...
    .pipe(gulp.dest(paths.images.dest1))
    .pipe(gulp.dest(paths.images.dest2))
    .pipe(browserSync.stream())
});
...
gulp.task('sprites', () => {
  return gulp.src(paths.svgSprite.src)
    .pipe(plumber())
    .pipe(newer(paths.svgSprite.dest1))
    .pipe(newer(paths.svgSprite.dest2))
    .pipe(imagemin([
        imagemin.svgo({
            plugins: [
                {
    ...
    .pipe(gulp.dest(paths.svgSprite.dest1))
    .pipe(gulp.dest(paths.svgSprite.dest2))
    .pipe(browserSync.stream())
});
...
gulp.task('svg', () => {
  return gulp.src(paths.svg.src)
    .pipe(plumber())
    .pipe(newer(paths.svg.dest1))
    .pipe(newer(paths.svg.dest2))
    .pipe(imagemin([
        imagemin.svgo({
            plugins: [
                {
    ...
    .pipe(gulp.dest(paths.svg.dest1))
    .pipe(gulp.dest(paths.svg.dest2))
    .pipe(browserSync.stream())
});
...
gulp.task('fonts', () => {
  return gulp.src(paths.fonts.src)
    .pipe(plumber())
    .pipe(newer(paths.fonts.dest1))
    .pipe(newer(paths.fonts.dest2))
    .pipe(gulp.dest(paths.fonts.dest1))
    .pipe(gulp.dest(paths.fonts.dest2))
    .pipe(browserSync.stream())
});
...
gulp.task('php', () => {
  return gulp.src(paths.php.src)
    ...
    .pipe(gulp.dest(paths.php.dest1))
    .pipe(gulp.dest(paths.php.dest2))
    .pipe(browserSync.stream())
});
...
gulp.task('clean', () => {
  return del([paths.prod.build1, paths.prod.build2]);
});
...
gulp.task('server', () => {
  browserSync.init({
    server: {
      baseDir: [paths.prod.build1, paths.prod.build2]
    },
